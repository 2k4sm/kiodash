    ...
    return (
        ...
        >
            <div className="flex justify-evenly items-center mt-5">
                ...
                <button className="sm:hidden block bg-slate-800 rounded-md p-1" onClick={toggleSidebar}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="red"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z" /></svg>
                </button>
            </div>
